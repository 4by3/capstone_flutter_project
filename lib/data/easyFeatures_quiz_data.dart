...
final Map<int, List<Map<String, dynamic>>> easyFeatureQuestions = {
  0: [
    ...
    {
      'question':
          "A user you don't know has sent you multiple inappropriate messages. What should you do?",
      'options': [
    ...
    {
      'question':
          'You find a Facebook profile impersonating you. What should you do?',
      'options': [
        'A) Ignore it',
    ...
    {
      'question':
          "A friend keeps posting comments on your personal photos that makes you uncomfortable, but you don't want to unfriend them because they are part of your social circle. \n Do you: ",
      'options': [
  ...
  1: [
    ...
    {
      "question":
          "What happens when you switch a Facebook group from private to public?",
      "options": [
    ...
    {
      "question":
          "If you leave a Facebook group, what happens to the posts you shared in the group?",
      "options": [
    ...
    {
      "question":
          "What can group admins do to enhance privacy in a Facebook group?",
      "options": [
  ...
  4: [
    ...
    {
      'question':
          'When someone tags you in a post and you have tag review turned on, what happens next?  ',
      'options': [
    ...
    {
      //Cluster 1: understanding tag review
